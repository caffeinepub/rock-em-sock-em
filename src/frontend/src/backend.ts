...
export class Backend implements backendInterface {
    ...
    async getWins(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getWins(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async recordWin(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordWin(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
